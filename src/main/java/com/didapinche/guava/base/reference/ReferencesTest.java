...
public class ReferencesTest {
    ...
    public void weakHashMap() throws InterruptedException {
        ...
        Object value = new VeryBig("weakHashMap value");
...
//                e.printStackTrace();
    ...
    @Test
    public void referenceFinaQueueWithWeakReference() throws InterruptedException {
        Object referent = new VeryBig("referenceQueueWithWeakReference");
        final FinalizableReferenceQueue referenceQueue = new FinalizableReferenceQueue();
        FinalizableWeakReference ref = new FinalizableWeakReference<Object>(referent, referenceQueue) {
            @Override
            public void finalizeReferent() {
                System.out.println("FinalizableWeakReference.finalizeReferent");
            }
        };
...
//        assertNull(removed.get());
    ...
    public void referenceQueueWithSoftReference() throws InterruptedException {
        ...
        System.out.println(referenceQueue.poll());
        Reference<? extends Object> removed = referenceQueue.remove();
        System.out.println(removed.get());
        assertNotNull(removed);
        assertSame(ref, removed);
        assertNull(removed.get());
    }
